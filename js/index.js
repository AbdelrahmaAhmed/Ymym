...
$("#openTap").click(() => {
  ...
  async function displayArea() {
    ...
    for (let i = 0; i < data.length; i++) {
      ...
      <img src="../imgs/house-laptop-solid.svg" alt="" class="w-50 bg-white">
  ...
  async function displayIngred() {
    ...
    for (let i = 0; i < 20; i++) {
      ...
      <img src="../imgs/drumstick-bite-solid.svg" alt="" class="w-50 bg-white" >
...
// <img src="${myData[i].categories}" alt="">
// </div>`

//         console.log(JSON.parse(myHttp.response));

//     }
//     document.getElementById("MY").innerHTML = cartona;
// }
